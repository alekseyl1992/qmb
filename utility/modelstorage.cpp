...
{
    return "ћодель 1"; //TODO возвращать им€ модели (из пол€ xml)
}
...
{
    //TODO здесь мен€ем им€ документа на name!
}
...
bool ModelStorage::setCodeString(QString code)
{
    ...
    //QDom технологи€ считывает и строит все дерево сразу
    //QSax обрабатывает текст построчно... поэтому реализаци€ исключений
    //с возвратом номера строки € думаю невозможна. нужно что-нибудь другое.
}
