...
namespace logic
{
    //! Класс является элементом для модели (класс model).
    /*!
     * Представляет собой объект, который содержит списки объектов и реализует все связи между объектами модели.
     */
